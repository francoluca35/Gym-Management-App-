  ...
  const handleCheckGym = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (gymCheck.exists) {
        ...
        setError("No se encontró un gimnasio registrado con esta IP. Revisa la consola del navegador para más detalles. Por favor, regístrate primero o verifica que la IP coincida.");
      }
    } catch (err: any) {
